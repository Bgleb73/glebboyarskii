...
> Специфика подачи информации на лендингах иная, это быстрое знакомство с продуктом и цель захвата лида должно произойти как можно быстрее, структура страницы и ее контент подразумеват очень беглый просмотр, скроллинг, его и нужно отслеживать.
...
## И еще один тег для запуска отслеживания
