---
description: "DOM и BOM для веб-аналитиков: как заглянуть под капот сайта и отслеживать любые действия. Руководство по CSS-селекторам, консоли браузера и работе с тег-менеджерами."
---
